...
import { getAuth, createUserWithEmailAndPassword, validatePassword, sendEmailVerification } from "https://www.gstatic.com/firebasejs/11.2.0/firebase-auth.js"
            ...
            createUserWithEmailAndPassword(auth, email.value, password.value)
                .then(async (userCredential) => {
                    ...
                    await setDoc(doc(firestore, "users", user.email), {
                        display_picture: "https://firebasestorage.googleapis.com/v0/b/one-5769e.firebasestorage.app/o/user_placeholder.jpg?alt=media&token=356c6aa7-a290-4167-a0c6-e9f72bef8909",
                        email: user.email,
                        profile_description: "",
                        uid: user.uid,
